			...
			<div class="card">
				...
				<div class="table-box">
					<el-table
							...
							style="width: 100%">
						<el-table-column label="卡号" width="82" align="center">
						...
						<el-table-column width="120" label="批次时间" align="center">
							<template slot-scope="scope">
								<span :class="{ over: scope.row.isOver < 0 }">{{ scope.row.batchTime }}</span>
							</template>
						</el-table-column>
						...
						<el-table-column label="备注" align="center">
							<template slot-scope="scope">
								<span :class="{ over: scope.row.isOver < 0 }">{{ scope.row.remark }}</span>
							</template>
						</el-table-column>
...
//					    console.log(data)
						...
						this.overview.overCard = data.overCardCount
					}
				})
			},
			// 获取到表格数据
